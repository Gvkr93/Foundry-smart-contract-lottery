...
contract VRFCoordinatorV2_5Mock is SubscriptionAPI, IVRFCoordinatorV2Plus {
  ...
  function removeConsumer(
    ...
    revert("removeConsumer not implemented in mock");
  }

  /**
   * @inheritdoc IVRFSubscriptionV2Plus
   */
  function cancelSubscription(uint256 _subId, address _to) external override {
    revert("cancelSubscription not implemented in mock");
  }
